module Make.Pipeline.Generate exposing (..)
...
generate :
    ...
    -> EveryDict CanonicalModule Location
...
getReachableObjectFiles debug moduleNames allNodes =
    let
        ...
        keyToVertex modul =
            EveryDict.get modul keyToVertexDict
    ...
    in
        Graph.topologicalSort graph
            ...
            |> List.filterMap (\modul -> EveryDict.get modul nodeToFilePath)
