...
then
    ...
    echo "(4/$total_steps) Building on Gigalixir"
    git push -f gigalixir HEAD:refs/heads/master
    
    echo "(5/$total_steps) Running database migrations"
