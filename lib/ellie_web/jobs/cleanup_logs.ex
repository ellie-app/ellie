defmodule EllieWeb.Jobs.CleanupLogs do
  ...
  defp get_old_issue_ids() do
    url = "https://sentry.io/api/0/projects/ellie-app/ellie/issues/?query=age:%2B6d&statsPeriod="
  ...
  defp delete_issues(ids) do
    case ids do
      ...
      some_ids ->
        ...
        url = "https://sentry.io/api/0/projects/ellie-app/ellie/issues/?" <> ids_query
